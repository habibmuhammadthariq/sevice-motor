...
<body>
	...
	<div class="form" style="background-color: #34495e; height: 50px; width: 1366px">
	  ...
	  <form method="post" action="<?= base_url('pembelian/create/') . $transaksi['kode_transaksi']; ?>">
		<table class="table table-stripped" align="center">
	  	  <tr>
	  	  	<td><label>Kode Transaksi</label></td>
	  	 	<td>
	  	 		<input type="text" name="kode_transaksi" class="form-control" value="<?= $transaksi['kode_transaksi']; ?>" disabled>
	  	 	</td>
	  	  </tr>
	  	  <tr>
	  	  ...
	  	  <tr>
	  	 	<td><label>Jumlah</label></td>
	  	  	<td>
	  	  		<input type="number" name="jumlah" class="form-control" class="form-control">
	  	  	</td>
	      </tr>
	      <tr>
	      	<td><button type="submit" class="btn btn-primary">Submit</button></td>
	      	<td>
	      	  <a class="btn btn-secondary" href="<?= base_url('pembelian/read/') . $transaksi['kode_transaksi'] ?>">Batal</a>
	      	</td>
	      </tr>
		</table>	
	  </form>
