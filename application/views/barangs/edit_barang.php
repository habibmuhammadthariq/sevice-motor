		...
		<form method="POST" action="<?= base_url('barang/update'); ?>">
		  ...
		  <table align="center" class="table table-stripped">
		  	<tr>	
				...
				<td> <input type="text" name="kode_barang" class="form-control" value="<?= $barang['kode_barang']; ?>"> </td>
			</tr>
			<tr>
				<td><label>nama</label></td>
				<td><input type="text" name="nama" class="form-control" value="<?= $barang['nama']; ?>"></td>
			</tr>
			<tr>
				<td><label>Tipe</label></td>
				<td><input type="text" name="tipe" class="form-control" value="<?= $barang['tipe']; ?>"></td>
			</tr>
			<tr>
				<td><label>Kategori</label></td>
				<td><input type="text" name="kategori" class="form-control" value="<?= $barang['kategori']; ?>"></td>
			</tr>
			<tr>
				<td><label>Merk</label></td>
				<td><input type="text" name="merk" class="form-control" value="<?= $barang['merk']; ?>"></td>
			</tr>
			<tr>
				<td><label>Stok</label></td>
				<td><input type="number" name="stok"  class="form-control" value="<?= $barang['stok']; ?>"></td>
			</tr>
			<tr>
				<td><label>Harga</label></td>
				<td><input type="number" name="harga" class="form-control" value="<?= $barang['harga']; ?>"></td>
			</tr> 
			<tr>
