...
<body>
			...
			<div align="right">
			  <font color="white" size="5">
			    ...
			    <span class="coba" align="center">
	      	  	  <font size="1"><?= $this->session->userdata['username'];?></font>
	      		</span>
	      	  </font>
	    	</div>
		    </div>
	...
	<div class="row no-gutters">
	  ...
	  <div class="col-6 col-md-10">		
		...
		<br>
		<center><h3>Data Identitas Karyawan</h3></center>
		...
		<?php foreach ($user as $users) : ?>
			<tbody>
				...
				<td>
					<a href="<?= base_url('user/replace/') . $barang['kode_barang'];?>">
						<button type="button" class="btn btn-warning">Update</button>
					</a>
					<a href="<?= base_url('user/delete/') . $barang['kode_barang']; ?>">
